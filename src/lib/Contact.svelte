          ...
          <div class="flex flex-wrap pt-12 lg:pt-0">
            ...
            >
              <div class="flex items-start">
                <div class="shrink-0">
                  <div
                    class="p-4 bg-gray-800 rounded-md shadow-md w-14 h-14 flex items-center justify-center"
                  >
                    <svg
                      aria-hidden="true"
                      focusable="false"
                ...
                <div class="grow ml-6">
                  <p class="font-bold mb-1">Respondemos tus dudas</p>
                  <p class="text-gray-500">escapetours.mex@gmail.com</p>
            ...
            >
              <div class="flex items-start">
                ...
                <div class="grow ml-6">
                  <p class="font-bold mb-1">Precios accesibles</p>
                  <p class="text-gray-500">escapetours.mex@gmail.com</p>
                  <p class="text-gray-500">(+64) 21023238</p>
                </div>
              </div>
            ...
            >
              <div class="flex align-start">
                ...
                <div class="grow ml-6">
                  <p class="font-bold mb-1">Informar un problema</p>
                  <p class="text-gray-500">escapetours.mex@gmail.com</p>
                  <p class="text-gray-500">(+64) 21023238</p>
                </div>
              </div>
