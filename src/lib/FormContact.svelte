      ...
      <div class="w-full sm:w-auto lg:w-1/2 xl:w-6/12 px-4">
        <div class="max-w-lg mb-12 lg:mb-0">
          ...
          <p class="text-gray-400 leading-relaxed mb-6 sm:mb-9">
            El equipo de escape tours está listo para ayudarte a planificar tu
            próximo viaje. Si tienes alguna pregunta, no dudes en contactarnos.
          </p>
        </div>
      </div>
      <div class="w-full sm:w-auto lg:w-1/2 xl:w-5/12 px-4">
        <div class="bg-[#F4F4F4] relative rounded-lg p-8 sm:p-12 shadow-lg">
          <form>
